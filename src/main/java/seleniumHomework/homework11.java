...
import static org.junit.Assert.assertTrue;
    ...
    public class EmuSimWebAppTests extendsMobileTestsBase {
...
// {"Safari", "iOS", "14.3", "iPhone SE (2nd generation) Simulator"},
        ...
        @Before
        public void setUp() throwsMalformedURLException {
//Configure these using Platform Configurator:
// https://wiki.saucelabs.com/display/DOCS/Platform+Configurator#/
            MutableCapabilities capabilities = newMutableCapabilities();
